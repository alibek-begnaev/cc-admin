  ...
  return (
    <Routes>
      ...
      >
        ...
        <Route element={<CreditContextProvider />}>
          <Route path="credit/customers" element={<LendoCustomerList />}></Route>
          <Route
          ...
          ></Route>
          <Route
            path="credit/skoring-application-details/:appId"
            element={<ApplicationDetails />}
          ></Route>
          <Route path="credit/lendo-request" element={<LendoRequest />}></Route>
        </Route>
